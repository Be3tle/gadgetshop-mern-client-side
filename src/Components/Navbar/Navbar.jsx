...
const Navbar = () => {
  ...
  return (
    <div className="navbar md:fixed z-10 bg-opacity-70 md:bg-opacity-30  bg-white max-w-screen-2xl mx-auto">
      ...
      <div className="navbar-end">
        ...
        {user ? (
          <button
            ...
            className="btn bg-cyan-500 border-0 hover:bg-cyan-700 text-white"
          >
            Sign out
          </button>
        ) : (
